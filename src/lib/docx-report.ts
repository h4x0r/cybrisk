...
function buildDocument(
  ...
  const references: { source: string; publication: string; url: string; usedFor: string }[] = [
    {
      source: 'IBM Security',
      publication: 'Cost of a Data Breach Report 2025',
      url: 'https://www.ibm.com/reports/data-breach',
      usedFor: 'Per-record costs, industry benchmarks, control effectiveness',
    },
    {
      source: 'Verizon',
      publication: 'Data Breach Investigations Report (DBIR) 2025',
      url: 'https://www.verizon.com/business/resources/reports/dbir/',
      usedFor: 'Attack pattern frequencies, threat event frequency calibration',
    },
    {
      source: 'NetDiligence',
      publication: 'Cyber Claims Study 2025',
      url: 'https://netdiligence.com/cyber-claims-study/',
      usedFor: 'Claim severity distributions by revenue band',
    },
    {
      source: 'The Open Group',
      publication: 'OpenFAIR Standard (O-RA)',
      url: 'https://www.opengroup.org/certifications/openfair',
      usedFor: 'FAIR risk taxonomy and quantitative methodology',
    },
    {
      source: 'Gordon & Loeb',
      publication: 'Managing Cybersecurity Resources (2002)',
      url: 'https://doi.org/10.1145/581271.581274',
      usedFor: 'Optimal security investment model (1/e coefficient)',
    },
    {
      source: 'European Commission',
      publication: 'GDPR — General Data Protection Regulation',
      url: 'https://commission.europa.eu/law/law-topic/data-protection_en',
      usedFor: 'EU/UK regulatory fine exposure (up to 4% of revenue)',
    },
    {
      source: 'HK PCPD',
      publication: 'Personal Data (Privacy) Ordinance (PDPO)',
      url: 'https://www.pcpd.org.hk/',
      usedFor: 'Hong Kong regulatory fine exposure',
    },
    {
      source: 'PDPC Singapore',
      publication: 'Personal Data Protection Act (PDPA)',
      url: 'https://www.pdpc.gov.sg/',
      usedFor: 'Singapore regulatory fine exposure',
    },
    {
      source: 'NCSL',
      publication: 'Security Breach Notification Laws',
      url: 'https://www.ncsl.org/technology-and-communication/security-breach-notification-laws',
      usedFor: 'US state-level breach notification requirements',
    },
  ];
  ...
  const refRows = [
    new TableRow({
      children: [
        headerCell('Source', 20),
        headerCell('Publication', 35),
        headerCell('Used For', 45),
      ],
    }),
  ];
          ...
          default: new Footer({
            children: [
              new Paragraph({
                children: [
                  new TextRun({
                    text: 'CONFIDENTIAL | Generated by ',
                    size: 16,
                    color: MID_GRAY,
                    font: 'Calibri',
                  }),
